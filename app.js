...
app.use((req, res, next) => {
  app.header("Allow-Control-Allow-Origin", "*"); // u can uneven restrict it app.header('Allow-Control-Allow-Origin','https://myCoolPage.com')
...
//since browser  always  sent the options request whenever  u send PUT or POST
  if(req.method == 'OPTIONS'){
      app.header('Allow-Control-Allow-Methods','PUT , POST, DELETE, GET')
